...
async function getAuthorizedOrganization(userId: string, profileId: string, organizationId: string) {
  if (userId !== profileId) {
    return null;
  }
...
export async function PATCH(
  ...
  try {
    ...
    const organization = await getAuthorizedOrganization(userId, params.id, params.organizationId);
    if (!organization) {
    ...
    console.error('Error updating workspace organization location:', error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Error deleting workspace organization location:', error);
