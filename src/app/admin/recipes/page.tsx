...
export default async function AdminRecipesPage() {
  ...
  const recipeCategories = await db.category.findMany({
    where: {
      isArchived: false,
      contentModel: 'RECIPE',
      ...
      <div className="admin-card">
        <div className="admin-card-header">
          <div className="flex items-center gap-0">
            ...
            <div className="admin-card-header-label">Recipes</div>
          </div>
        </div>
        <div className="admin-card-body">
          <RecipeTabs recipes={recipes} recipeCategories={recipeCategories} />
        </div>
