...
export const ACTIONS = {
  ...
  CREATE_REPORTER_RUN: 'CREATE_REPORTER_RUN',
  VIEW_REPORTER_RUN: 'VIEW_REPORTER_RUN',
  EDIT_REPORTER_RUN: 'EDIT_REPORTER_RUN',
  ASSIGN_REPORTER_RUN: 'ASSIGN_REPORTER_RUN',
  ADD_REPORTER_SOURCE: 'ADD_REPORTER_SOURCE',
  GENERATE_REPORTER_DRAFT: 'GENERATE_REPORTER_DRAFT',
  CONVERT_REPORTER_TO_ARTICLE: 'CONVERT_REPORTER_TO_ARTICLE',
...
permissionMatrix.set('TRUSTED-CONTRIBUTOR', new Set([
  ACTIONS.CREATE_ARTICLE,
  ACTIONS.CREATE_REPORTER_RUN,
  ACTIONS.VIEW_REPORTER_RUN,
  ACTIONS.EDIT_REPORTER_RUN,
  ACTIONS.ADD_REPORTER_SOURCE,
  ACTIONS.EDIT_ARTICLE,
...
permissionMatrix.set('TRUSTED-STAFF_WRITER', new Set([
  ...
  ACTIONS.EDIT_REPORTER_RUN,
  ACTIONS.ADD_REPORTER_SOURCE,
  ACTIONS.GENERATE_REPORTER_DRAFT,
  ACTIONS.EDIT_ARTICLE,
  ACTIONS.DELETE_ARTICLE,
...
permissionMatrix.set('TRUSTED-EDITOR', new Set([
  ...
  ACTIONS.VIEW_REPORTER_RUN,
  ACTIONS.EDIT_REPORTER_RUN,
  ACTIONS.ASSIGN_REPORTER_RUN,
  ACTIONS.ADD_REPORTER_SOURCE,
  ACTIONS.GENERATE_REPORTER_DRAFT,
  ACTIONS.CONVERT_REPORTER_TO_ARTICLE,
  ACTIONS.EDIT_ARTICLE,
  ACTIONS.DELETE_ARTICLE,
  ACTIONS.PUBLISH_ARTICLE,
...
const legacyPermissionMap: Record<string, Action> = {
  ...
  'reporter:create':     ACTIONS.CREATE_REPORTER_RUN,
  'reporter:view':       ACTIONS.VIEW_REPORTER_RUN,
  'reporter:edit':       ACTIONS.EDIT_REPORTER_RUN,
  'reporter:assign':     ACTIONS.ASSIGN_REPORTER_RUN,
  'reporter:source:add': ACTIONS.ADD_REPORTER_SOURCE,
  'reporter:draft':      ACTIONS.GENERATE_REPORTER_DRAFT,
  'reporter:convert':    ACTIONS.CONVERT_REPORTER_TO_ARTICLE,
  ...
  'analytics:view':      ACTIONS.VIEW_ANALYTICS,
