...
> **Last updated:** 2026-04-08 (session 122 — documented trusted-user directory defaults, super-admin profile editing, the admin users `No directory` filter, and the simplified public organization page header/rich-text rendering notes)
