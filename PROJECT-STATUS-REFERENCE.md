...
> **Last updated:** 2026-04-08 (session 127 — documented the nested admin organization-forms UI polish, including `List` / `+ Form`, `Details` / `Questions` / `Results` / `+ Question`, list-first question rows, and the compacted managed-form header)
