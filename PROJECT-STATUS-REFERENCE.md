...
> **Last updated:** 2026-03-29 (session 93 — documented the compact `/admin/users` rebuild, inline admin messaging dialog, real `Last Seen` login timestamps, and the latest admin sidebar ordering changes)
