...
> **Last updated:** 2026-03-26 (session 70 — routed first-time Google sign-ins through a post-auth landing step so newly created social users land on their edit-profile page, added a profile-level DOB reminder banner for users missing DOB, and kept the existing login sign-up DOB guidance aligned with that prompt)
