...
> **Last updated:** 2026-03-27 (session 81 — refactored the public Local Life article detail route around reusable `article-card*` structure/classes, tightened the reader/comment layout, removed the right-hand Article Details card, and made commenting trusted-user-only with a dialog explainer for registered users plus a denser inline comment action treatment)
