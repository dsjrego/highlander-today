...
> **Last updated:** 2026-03-27 (session 76 — refined the homepage featured-story cards so single featured items no longer sit awkwardly in a half-empty two-column row, and added a branded fallback media panel for featured articles that do not have a hero image yet)
