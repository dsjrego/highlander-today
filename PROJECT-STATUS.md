...
> **Last updated:** 2026-03-25 (session 60 — refined the shared About card system so `card-label` and `card-title` always stack as distinct rows, added named title-size variants `card-title-hero`, `card-title-lg`, `card-title-md`, and `card-title-sm`, and updated the About pages plus documentation to use the formalized card vocabulary)
