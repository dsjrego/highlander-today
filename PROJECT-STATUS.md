...
> **Last updated:** 2026-03-25 (session 62 — updated the live footer in `src/app/layout.tsx` to use shared `Support` and `About` nav data, renamed the right footer column heading to `Highlander Today`, and switched the footer to a centered header-style gradient treatment)
