  ...
  const categoryHierarchy = [
    {
      ...
      slug: 'local-life',
      children: [
        { name: 'Local Stores',             slug: 'local-stores' },
        { name: 'Our People',               slug: 'people' },
        { name: 'Recipes & Food',           slug: 'recipes-food' },
        { name: 'Gardening & Nature',       slug: 'outdoors-tips' },
        { name: 'Arts & Music',             slug: 'arts-creativity' },
        { name: 'History & Heritage',       slug: 'history-heritage' },
        { name: 'Guides & How-Tos',         slug: 'guides' },
        { name: 'Opinion',                  slug: 'opinion-commentary' },
      ],
    },
    {
      name: 'Experiences',
